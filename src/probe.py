...
@click.option('--processing', type=str, default="parallel")
...
@click.option('--in_filter', type=str, default="generation_")
...
def main(
    ...
    for parsed_template_index in template_indices:
        ...
        encoding_files = glob.glob(f"{encoding_folder_structure}/**/*.*")
